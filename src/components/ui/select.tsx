...
// Add a global style component that can be included once in the app
const NoAnimationStyles = () => (
  <style jsx global>{`
    /* Target animation properties only, not positioning */
    [data-radix-popper-content-wrapper] {
      transition: none !important;
    }
    
    /* Disable animation states but keep positioning */
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <>
    {/* Include the global styles outside the Portal */}
    <NoAnimationStyles />
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        style={{
          animation: "none",
          transition: "none",
          // Don't override transform as it's needed for positioning
        }}
      >
